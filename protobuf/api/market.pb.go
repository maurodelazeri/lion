...
type MarketKindSummaryResponse struct {
	...
	MarketsKindSummary   []*MarketKindSummary `protobuf:"bytes,2,rep,name=markets_kind_summary,json=marketsKindSummary,proto3" json:"markets_kind_summary,omitempty"`
...
func (m *MarketKindSummaryResponse) GetMarketsKindSummary() []*MarketKindSummary {
	if m != nil {
		return m.MarketsKindSummary
	}
	return nil
}
...
type MarketProductSummaryResponse struct {
	Retcode               Retcode                 `protobuf:"varint,1,opt,name=retcode,proto3,enum=api.Retcode" json:"retcode,omitempty"`
	MarketsProductSummary []*MarketProductSummary `protobuf:"bytes,2,rep,name=markets_product_summary,json=marketsProductSummary,proto3" json:"markets_product_summary,omitempty"`
	Comment               string                  `protobuf:"bytes,3,opt,name=comment,proto3" json:"comment,omitempty"`
	Elapsed               string                  `protobuf:"bytes,4,opt,name=elapsed,proto3" json:"elapsed,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                `json:"-"`
	XXX_unrecognized      []byte                  `json:"-"`
...
func (m *MarketProductSummaryResponse) GetMarketsProductSummary() []*MarketProductSummary {
	if m != nil {
		return m.MarketsProductSummary
	}
	return nil
}
...
var fileDescriptor_3f90997f23a2c3f8 = []byte{
	...
	,
}
