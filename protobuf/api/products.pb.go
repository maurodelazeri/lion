...
func (dst *ProductDataFeedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProductDataFeedRequest.Merge(dst, src)
}
...
func (dst *ProductDataFeedResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProductDataFeedResponse.Merge(dst, src)
}
