...
const websocketURL = "wss://ws-feed.pro.bitfinex.com"
...
func (r *Bitfinex) Setup(venueName string, config config.VenueConfig, streaming bool, maxLevelsOrderBook int, mode ...pbAPI.SystemMode) {
