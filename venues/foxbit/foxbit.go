...
const (
	websocketURL = "wss://apifoxbitprodlb.alphapoint.com/WSGateway/"
	// Public endpoints
...
// Websocket is the overarching type across the Foxbit package
...
func (r *Foxbit) SetDefaults() {
	r.Enabled = true
	r.Base.LiveOrderBook = utils.NewConcurrentMap()
}

// Setup initialises the venue parameters with the current configuration
func (r *Foxbit) Setup(venueName string, config config.VenueConfig, streaming bool, maxLevelsOrderBook int, mode ...pbAPI.SystemMode) {
