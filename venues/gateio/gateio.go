...
const (
	websocketURL = "wss://ws.gate.io/v3/"
	//websocketURL = "wss://ws.gateio.ws/v3/"
...
// Websocket is the overarching type across the Gateio package
...
func (r *Gateio) SetDefaults() {
	r.Enabled = true
	r.LiveOrderBook = utils.NewConcurrentMap()
}

// Setup initialises the venue parameters with the current configuration
func (r *Gateio) Setup(venueName string, config config.VenueConfig, streaming bool, maxLevelsOrderBook int, mode ...pbAPI.SystemMode) {
