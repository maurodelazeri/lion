...
const (
	websocketURL = "wss://ws-feed.pro.huobi.com"
	// Public endpoints
...
// Websocket is the overarching type across the Huobi package
...
func (r *Huobi) SetDefaults() {
	r.Enabled = true
	r.Base.LiveOrderBook = utils.NewConcurrentMap()
}

// Setup initialises the venue parameters with the current configuration
func (r *Huobi) Setup(venueName string, config config.VenueConfig, streaming bool, maxLevelsOrderBook int, mode ...pbAPI.SystemMode) {
